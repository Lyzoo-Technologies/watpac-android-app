...
public class EngineerCentringActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_engineer_centring);
        ...
        findViewById(R.id.upload_image7).setOnClickListener(v -> openFileChooser("upload_image7"));
        findViewById(R.id.upload_image8).setOnClickListener(v -> openFileChooser("upload_image8"));

        // Initialize LinearLayouts
        LinearLayout engihome = findViewById(R.id.engihome1);
        LinearLayout engiupload = findViewById(R.id.engiupload1);
        LinearLayout engilogout = findViewById(R.id.engilogout1);
        ...
        engihome.setOnClickListener(v -> {
            Intent intent = new Intent(EngineerCentringActivity.this, EngineerDashboardActivity.class);
            startActivity(intent);
        });

        engiupload.setOnClickListener(v -> {
            Intent intent = new Intent(EngineerCentringActivity.this, EngineerUploadActivity.class);
            startActivity(intent);
        });

        engilogout.setOnClickListener(v -> {
            // Perform logout (optional: clear session data)
            Intent intent = new Intent(EngineerCentringActivity.this, SignInActivity.class);
