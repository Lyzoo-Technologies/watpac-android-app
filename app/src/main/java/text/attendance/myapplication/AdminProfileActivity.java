...
public class AdminProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        profilePassword.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(AdminProfileActivity.this, ConfirmPasswordActivity.class);
        ...
        homeLayout.setOnClickListener(v -> {
            Intent homeIntent = new Intent(AdminProfileActivity.this, AdminDashboardActivity.class);
            startActivity(homeIntent);
        });

        uploadLayout.setOnClickListener(v -> {
            Intent uploadIntent = new Intent(AdminProfileActivity.this, AdminAdActivity.class);
