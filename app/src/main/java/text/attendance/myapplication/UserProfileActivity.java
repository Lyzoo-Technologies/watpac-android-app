...
public class UserProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        profilePassword.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(UserProfileActivity.this, ConfirmPasswordActivity.class);
        ...
        homeLayout.setOnClickListener(v -> {
            Intent homeIntent = new Intent(UserProfileActivity.this, EngineerDashboardActivity.class);
            startActivity(homeIntent);
        });

        uploadLayout.setOnClickListener(v -> {
            Intent uploadIntent = new Intent(UserProfileActivity.this, EngineerUploadActivity.class);
