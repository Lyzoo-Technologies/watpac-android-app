...
public class UserProjectActivity extends AppCompatActivity implements PaymentResultListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Home and Logout functionality
        LinearLayout userhome = findViewById(R.id.userhome3);
        LinearLayout userlogout = findViewById(R.id.userlogout3);

        userhome.setOnClickListener(v -> {
            Intent homeIntent = new Intent(UserProjectActivity.this, UserCommentActivity.class);
            startActivity(homeIntent);
        });

        userlogout.setOnClickListener(v -> {
            Intent logoutIntent = new Intent(UserProjectActivity.this, SignInActivity.class);
