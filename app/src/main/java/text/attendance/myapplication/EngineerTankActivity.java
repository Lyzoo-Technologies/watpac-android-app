...
public class EngineerTankActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayout engihome = findViewById(R.id.engihome9);
        LinearLayout engiupload = findViewById(R.id.engiupload9);
        LinearLayout engilogout = findViewById(R.id.engilogout9);
        ...
        engihome.setOnClickListener(v -> {
            Intent intent = new Intent(EngineerTankActivity.this, EngineerDashboardActivity.class);
            startActivity(intent);
        });

        engiupload.setOnClickListener(v -> {
            Intent intent = new Intent(EngineerTankActivity.this, EngineerUploadActivity.class);
            startActivity(intent);
        });

        engilogout.setOnClickListener(v -> {
            // Perform logout (optional: clear session data)
            Intent intent = new Intent(EngineerTankActivity.this, SignInActivity.class);
